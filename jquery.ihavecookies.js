...
(function ($) {
  ...
  $.fn.ihavecookies = function (options, event) {
    ...
    if (!myCookie || !myCookiePrefs || event == 'reinit') {
      ...
      $.each(settings.cookieTypes, (index, field) => {
      ...
      $('body').on('click', '#gdpr-cookie-accept', () => {
        // Set cookie
        ...
        const prefs = [];
        $.each($('input[name="gdpr[]"]').serializeArray(), (i, field) => {
      ...
      $('body').on('click', '#gdpr-cookie-advanced', () => {
  ...
  /*
    ...
    |
    */
  const dropCookie = (value, expiryDays) => {
  ...
  /*
    ...
    |
    */
  const setCookie = (name, value, expiry_days) => {
    const d = new Date();
